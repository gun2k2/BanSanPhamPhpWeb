...
<div class="page-body">
    ...
    <?php if($login):?>
    <?php redirect(base_url('trangchu'));  ?>
        <?php else:?>
            ...
            <!-- ĐĂNG NHẬP -->
                <div class="hidden-xs hidden-sm hidden-md col-lg-1 item-mainbar">
                     <div class="top_left fw">
                            <ul>
                                <li class="cp-item">
                                    <a href="<?php echo base_url(); ?>login" title="Đăng nhập" class="btn-transition">
                    ...
                    <a class="image-hover-line" title="mô tả ảnh 1"
                       href=":;">
                        <img class="img-responsive image-line" src=""
                             data-lazyload="<?php echo base_url(); ?>images/sildemota1.png"
                             alt="mô tả ảnh 1"/>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <?php $price_new = $value->price - $value->discount;?>
                     <?php echo number_format($value->discount/$value->price*100)?>%
                         <?php else:?> 
                            <?php echo number_format( $value->price )?> %
                         <?php endif;?>
                                            </div>
                                            <a href="<?php echo base_url()."sanpham/sanpham/".$value->id; ?>"
                                               title="  <?php echo $value->name; ?>">
                                             <img class="product-image" src="<?php echo base_url(); ?>images/product/<?php echo $value->image_link; ?>">
                                            </a>
                                        </div> <!-- END GIẢM GIÁ -->
                                        ...
                                        <div class="product-info"> <!-- INFO SẢN PHẨM -->
                                            <h3 class="product-name a-center">
                                               ...
                                               title="  <?php echo $value->name; ?>">
                                                ...
                                                Lượt xem : <?php echo $value->view ?> <i class="fa fa-eye" aria-hidden="true"></i>
                                            </h3>
                                               <div class="price-box price-loop-style res-item">
                        <?php if($value->discount > 0):?> <!-- chứng tỏ sản phẩm đã được giảm giá -->
                           <?php $price_new = $value->price - $value->discount;?>
                    <span class="special-price"><span class="price"><?php echo number_format($price_new)?> ₫</span></span>
                    <span class="old-price"><span class="price"><?php echo number_format( $value->price )?> ₫</span></span>
                    <?php else:?>
                        <span class="old-price"><span class="price"><?php echo number_format( $value->price )?> ₫</span></span>
                         <?php endif;?>  
                    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 banner_first">
                    <div class="item">
                        ...
                        >
                            <img 
                                 data-lazyload="<?php echo base_url(); ?>images/sildemota.png"
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 ">
                    <div class="item">
                        ...
                        >
                            <img
                                 data-lazyload="<?php echo base_url(); ?>images/sildemota.jpg"
                                ...
                                <div class="item"> <!-- SẢN PHẨM -->
                                    ...
                                    <div class="product-box">
                                        ...
                                        <div class="product-info">
                                            <h3 class="product-name a-center">
                                                <a href="<?php echo base_url()."sanpham/sanpham/".$value->id; ?>" title=" <?php echo $value->name; ?>">
                                                    <?php echo $value->name; ?>
...
Pc Gaming - Phụ Kiện Trang Trí - Laptop - Bàn Ghế.
                        ...
                        <div class="footer-detail">
                            <a href="<?php echo base_url(); ?>trangchu">
