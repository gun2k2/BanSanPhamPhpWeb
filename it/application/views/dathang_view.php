            ...
            <!-- ĐĂNG NHẬP -->
                <div class="hidden-xs hidden-sm hidden-md col-lg-1 item-mainbar">
                     <div class="top_left fw">
                            <ul>
                                <li class="cp-item">
                                    <a href="<<?php echo base_url(); ?>dathang/logout" title="Đăng Xuất" class="btn-transition">
                    ...
                    <div style="margin: 20px;padding-left: 20px;padding-right: 20px;">
                        <ol class="breadcrumb breadcrumb-arrows" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                            <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                                <a href="<?php echo base_url(); ?>trangchu" target="_self" itemprop="item"><span itemprop="name">Trang chủ</span></a>
                                <meta itemprop="position" content="1">
                            </li>
                            <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                                <a href="<?php echo base_url(); ?>giohang" target="_self" itemprop="item"><span itemprop="name">Giỏ hàng</span></a>
                        ...
                        <form accept-charset="UTF-8" action="https://fugear.vn/create-bill" id="customer_login" method="post">
                            <!-- <input type="hidden" name="_token" value="Xa9sld0SQTSmKT9CgyJ2h6Ro8WvryZLe8SeRzbU3"> -->

                            <div class="clearfix large_form ">
                                <label for="name" class="icon-field"><i class="icon-login icon-envelope "></i>Tên của bạn</label>
                                <input type="text" value="" name="name" required="" id="name" placeholder="Nhập tên của bạn" class="text form-control">
                            </div>
                            ...
                            <div class="clearfix large_form ">
                                ...
                                <input type="text" value="" name="sdt" id="phone" required="" placeholder="Nhập số điện thoại của bạn" class="text form-control">
                            </div>
                            
                            <div class="clearfix large_form ">
                                <label for="address" class="icon-field"><i class="icon-login icon-envelope "></i>Địa chỉ</label>
                                <input type="text" value="" name="diachi" id="address" required="" placeholder="Nhập địa chỉ của bạn" class="text form-control">
                            </div>
                            ...
                            <div class="clearfix large_form ">
                                <label for="city" class="icon-field"><i class="icon-login icon-envelope "></i>Quận/Huyện
</label>
                            ...
                            <div class="clearfix large_form ">
                                <label for="city" class="icon-field"><i class="icon-login icon-envelope "></i>Xã/Phường
</label>
                            ...
                            <div class="clearfix large_form ">
                                <label for="note" class="icon-field"><i class="icon-login icon-envelope "></i>Yêu cầu khác:</label>
                                <textarea id="note" name="note" rows="4" cols="50" placeholder="Nhập yêu cầu của bạn"></textarea>
                            </div>
                                                        <div class="clearfix action_account_custommer">
                                <div class="action_bottom button dark">
                                    <input onClick="return confirmSubmit()"  class="btn btn-buy btn-transition add_to_cart button-hover-3" type="submit" value="Hoàn tất">
                                </div>
                                <br>
                                <div class="req_pass">
                                    <a  href="<?php echo base_url(); ?>giohang"> &lt;&lt; Quay về giỏ hàng</a>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
        ...
        $(document).ready(function(){
            ...
            {
                $.ajax({
                    url:"<?php echo base_url(); ?>dathang/district",
                    method: "POST",
            ...
            if(district_id != '')
            {
                 $.ajax({
                    ...
                    url:"<?php echo base_url(); ?>dathang/ward",
                    method:"POST",
        ...
        {
        var agree=confirm("Bạn có muốn thanh toán?");
        if (agree)
         return true ;
        else
         return false ;
