          ...
          <div id="layoutSidenav">
           ...
           <!--  <?php $this->load->view('admin/message_view', $this->data);?> -->
            <div id="layoutSidenav_content">
                ...
                <form action="<?php echo base_url(); ?>admin/quanlysanpham_controller/updateDulieu" enctype="multipart/form-data" method="post" id="form" class="form">
                     <fieldset>
                <div class="widget">
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="file" name="image"  value="<?= $value['image_link'] ?>" id="image" size="25" required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="file" multiple="" value="<?= $value['image_list'] ?>" name="image_list[]" id="image_list" size="25"  >
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <span class="oneTwo">
                                <input type="text" _autocheck="true" class="format_number" id="param_price" style="width:100px"  value="<?= $value['price'] ?>" name="price" required="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <span>
                                <input type="text" value="<?= $value['discount'] ?>" class="format_number" id="param_discount" style="width:100px" name="discount" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <span class="oneTwo">
                                <input type="text" _autocheck="true" class="format_number" id="param_price" style="width:100px" name="hangsx" value="<?= $value['hangsx'] ?>" required="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <span class="oneTwo">
                                <input type="text" _autocheck="true" class="format_number" id="param_price" style="width:100px" name="baohanh" value="<?= $value['baohanh'] ?>" required="">
