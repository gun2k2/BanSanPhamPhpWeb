      ...
      <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
          ...
          <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <form action="<?php echo base_url(); ?>admin/quanlykhachhang_controller/updateDulieu" method="post"  enctype="multidata/form-data">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                      <input type="text" autocheck="true" name="username" value="<?= $value['username']?>" class="form-control" id="param_sdt"  placeholder="Tài khoản đăng nhập..." required=""> 
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    <label for="param_ngaysinh" class="col-sm-2 col-form-label">Địa chỉ</label>
                    <div class="col-sm-5">
