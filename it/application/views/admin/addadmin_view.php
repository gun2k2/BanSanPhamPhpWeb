                ...
                <main>
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                      <input type="date" autocheck="true" name="ngaysinh" value="<?php echo set_value('ngaysinh')?>" class="form-control" id="param_ngaysinh"  placeholder="Birthday..." required="">                    
                    </div>
                  </div>
    ...
    <?php endforeach; ?>
                  ...
                  <div class="form-group row">
                    <div class="col-sm-10">
                      ...
                      <a title="Trở về" class="tipS"  href="<?php echo base_url(); ?>admin/quanlyadmin_controller">
