      ...
      <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
          ...
          <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <form action="<?php echo base_url(); ?>admin/quanlyadmin_controller/updateDulieu" method="post"  enctype="multidata/form-data">
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                      <input type="date" autocheck="true" name="ngaysinh" value="<?= $value['ngaysinh']?>" class="form-control" id="param_ngaysinh"  placeholder="Birthday..." required=""> 
                    </div>
                  </div>

                  <div class="form-group row">
                    <label for="param_gioitinh"  class="col-sm-2 col-form-label" required="">Giới tính</label>
                    <div class="col-sm-5">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                      <input type="tell" autocheck="true" name="sdt" value="<?= $value['sdt']?>" class="form-control" id="param_sdt"  placeholder="Phone..." required=""> 
                    </div>
                  </div>
        ...
        $(document).ready(function(){
            ...
            {
                $.ajax({
                    url:"<?php echo base_url(); ?>admin/quanlyadmin_controller/district",
                    method: "POST",
            ...
            if(district_id != '')
            {
                 $.ajax({
                    ...
                    url:"<?php echo base_url(); ?>admin/quanlyadmin_controller/ward",
                    method:"POST",
