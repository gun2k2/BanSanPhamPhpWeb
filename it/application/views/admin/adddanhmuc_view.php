            ...
            <div id="layoutSidenav_content">
                <main>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                      <input type="text" autocheck="true" name="sort_order" value="<?php echo set_value('sort_order')?>" class="form-control" id="sort_order"  placeholder="...">
                  ...
                  <div class="form-group row">
                    <div class="col-sm-10">
                      ...
                      <a title="Trở về" class="tipS"  href="<?php echo base_url(); ?>admin/quanlydanhmuc_controller">
