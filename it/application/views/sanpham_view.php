                ...
                <div class="product-box">
                    ...
                    <?php $price_new = $value['price'] - $value['discount'];?>
                     <?php echo number_format($value['discount']/$value['price']*100)?>%
                         ...
                         <?php endif;?> </div>
                    <a href="<?php echo base_url()."sanpham/sanpham/".$value['id']; ?>" title="<?php echo $value['name']; ?>"><img class="product-image" src="<?php echo base_url(); ?>images/product/<?php echo $value['image_link']; ?>"> </a>
                    </div>
