                ...
                <ul id="nav" class="nav container"> <!-- 4 CỘT -->
                    ...
                    <?php  foreach ($danhmuc as $key => $value): ?>
                        <li class="dropdown-submenu nav-item-lv2">  <!-- MỤC ĐẦU TIÊN -->
                            <a class="nav-link"  href="<?php echo base_url(); ?>danhmuc/<?=$value['id']?>/<?= $value['name'] ?>" title="<?= $value['name'] ?>">
                ...
                <div class="product-box">
                    ...
                    <?php $price_new = $value->price - $value->discount;?>
                     <?php echo number_format($value->discount/$value->price*100)?>%
                         ...
                         <?php endif;?> </div>
                    <a href="<?php echo base_url()."index/sanpham/".$value->id; ?>" title=""><img class="product-image" src="<?php echo base_url(); ?>images/product/<?php echo $value->image_link; ?>"> </a>
                    </div>
                    <div class="product-info">
                    <h3 class="product-name a-center">
                    <a href="<?php echo base_url()."index/sanpham/".$value->id; ?>" title=" <?php echo $value->name; ?>">
