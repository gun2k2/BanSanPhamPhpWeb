            ...
            <div class="container">
                <div class="row">
                    <div style="margin: 20px;padding-left: 20px;padding-right: 20px;">
                        <form accept-charset="UTF-8"  id="customer_login" method="post" enctype="multidata/form-data" >
                            <div class="clearfix large_form ">
                                <label for="username" class="icon-field"><i class="icon-login icon-envelope "></i>Tài khoản</label>
                             <input type="text" value="" name="username" id="username" placeholder="Nhập tên đăng nhập" class="text form-control">
                            </div>
                            <div class="clearfix large_form ">
                                <label for="password" class="icon-field"><i class="icon-login icon-shield"></i>Mật khẩu</label>
                                <input type="password" name="password" id="password" placeholder="Nhập mật khẩu" class="text form-control" size="16">
                            </div>
                            <div class="clearfix action_account_custommer">
                                <div class="action_bottom button dark">
                                    ...
                                    &ensp;&ensp;&ensp; hoặc
                                    <a href="<?php echo base_url(); ?>login/registration" style="margin-left: 20px" title="Đăng ký tài khoản">Đăng ký tài khoản</a>
                                </div>
                                <br>
                                <div class="req_pass">
