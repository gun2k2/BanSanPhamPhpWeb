    ...
    <section class="lib-section-5">
                    ...
                    <div style="margin: 20px;padding-left: 20px;padding-right: 20px;">
                        ...
                        <form   method="post"  enctype="multidata/form-data">
                            <div class="clearfix large_form ">
                                ...
                                <input type="text" value="<?php echo set_value('name')?>" name="name" id="name" placeholder="Nhập tên của bạn" class="text form-control" required="" >
                            </div>
                            
                            <div class="clearfix large_form ">
                                <label for="email" class="icon-field"><i class="icon-login icon-envelope "></i>Email của bạn</label>
                                <input type="text" value="<?php echo set_value('email')?>" name="email" id="email" placeholder="Nhập email của bạn" class="text form-control" required="">
                            ...
                            <div class="clearfix large_form ">
                                ...
                                <input type="text" value="<?php echo set_value('sdt')?>" name="sdt" id="phone" placeholder="Nhập số điện thoại của bạn" class="text form-control" required="">
                            </div>
                            
                            <div class="clearfix large_form ">
                                <label for="username" class="icon-field"><i class="icon-login icon-envelope "></i>Tài khoản</label>
                                <input type="text" value="<?php echo set_value('username')?>" name="username" id="username" placeholder="Nhập tên đăng nhập" class="text form-control" required="">
        ...
        <input type="checkbox" name="acceptance-886" required="" value="1" aria-invalid="false" class="check-terms" />
                            ...
                            <div class="clearfix action_account_custommer">
                                ...
                                <br>
                                <div class="req_pass">
                                    <a href="<?php echo base_url(); ?>login/forgotpassword">Quên mật khẩu?</a>
                                </div>
                            </div>
                        </form>
                    </div>  
